...
- **GPU-ускорение**: Unified BGE-M3 embeddings с автоматическим выбором стратегии (ONNX+DirectML, BGE-M3+CUDA, Hybrid)
- **Умная маршрутизация**: Автоматический fallback между LLM провайдерами
- **Красивое форматирование**: MarkdownV2 через `telegramify-markdown` с эмодзи и структурированными ответами
