...
### 🆕 Основное руководство (v2.0)
👉 **[Quality Evaluation Guide](quality_evaluation_guide.md)** — Полное руководство по системе оценки качества

**Новое в v2.0:**
- ✅ Пользовательский feedback работает **независимо** от RAGAS
- ✅ Минимальная конфигурация для кнопок 👍/👎
- ✅ Обновлённая архитектура

### Быстрый старт
👉 **[Quick Start Guide](ragas_quickstart.md)** — Запуск за 5 минут

### Техническая документация RAGAS
👉 **[RAGAS Quality System](ragas_quality_system.md)** — Детали реализации RAGAS

**Содержание:**
- Архитектура RAGAS оценки
- API и интеграция
- Конфигурация
- Troubleshooting
- Roadmap
